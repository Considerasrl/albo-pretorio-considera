...
function albopc_LinkStampaAtto($id) {/* mr */
    if (current_user_can('admin_albo')) {
        echo '<a class="stpdf" href="' . esc_url(get_permalink() . '?action=printatto&id=' . $id . '&pdf=a') . '">'.esc_html__("Visualizza AVVISO DI INIZIO AFFISSIONE","albo-pretorio-on-line").'</a><a href="' . esc_url(get_permalink() . '?action=printatto&id=' . $id . '&pdf=c') . '" class="stpdf">'.esc_html__("Visualizza CERTIFICATO DI PUBBLICAZIONE","albo-pretorio-on-line").'</a>';
    }
}
...
function albopc_StampaAtto($id, $tipo) {
    ...
    if ($risultato->DataAnnullamento != '0000-00-00')
        $Annullato = '<p style="background-color: ' . $coloreAnnullati . ';text-align:center;font-size:1.5em;padding:5px;">'.__("Atto Annullato dal Responsabile del Procedimento","albo-pretorio-on-line").'<br /><br />'.__("Motivo","albo-pretorio-on-line").': <span style="font-size:1;font-style: italic;">' . stripslashes($risultato->MotivoAnnullamento) . '</span></p>';
    else
        $Annullato = '';
    ?>
    ...
    $rigadata = '<tr><td style="background: #fff; border: none; width: 50%; "><h4 style="background: #fff; border: none; font-size: 120%;">'.esc_html__("Data di inizio affissione","albo-pretorio-on-line").': <span style="font-weight:normal">' . esc_html(albopc_VisualizzaData($risultato->DataInizio)) . '</span></h4></td>'
            . '<td style="background: #fff; border: none; width: 50%;"><h4 style="background: #fff; border: none; font-size: 120%;">'.esc_html__("Data di fine affissione","albo-pretorio-on-line").': <span style="font-weight:normal">' . esc_html(albopc_VisualizzaData($risultato->DataFine)) . '</span></h4></td></tr>'
...
//    $user = get_user_by('login', $resp_pub[0]->Utente);
     if ($tipo == 'c') {
        $riga_tipo = __("CERTIFICATO DI PUBBLICAZIONE","albo-pretorio-on-line");
        $idtipo = 'printCertificato';
        $pubblicatoda = '';
    } elseif ($tipo == 'a') {
        $riga_tipo = __("AVVISO DI INIZIO AFFISSIONE","albo-pretorio-on-line");
        $idtipo = 'printAvviso';
    }
            ...
            <thead>
                ...
                <tr>
                    <td colspan="2" style="background: #fff; border: none">
                        <h2 style="font-size: 210%;"><?php  esc_html_e("Albo Pretorio","albo-pretorio-on-line");?></h2>
                    </td></tr>
                <tr>
                    <td colspan="2" style="background: #fff; border: none;">
                        <ul style="list-style: none;">
                        	<li><h4 style="font-size: 120%;"><?php  esc_html_e("Richidente","albo-pretorio-on-line");?>: <span style="font-weight:normal"><?php echo esc_html($risultato->Richiedente) ?></span></h4></li>
                        	<li><h4 style="font-size: 120%;"><?php  esc_html_e("Unità Organizzativa Responsabile","albo-pretorio-on-line");?>: <span style="font-weight:normal"><?php echo esc_html(stripslashes($Unitao->Nome)); ?></span></h4></li>
                         	<li><h4 style="font-size: 120%;"><?php  esc_html_e("Responsabile Del Procedimento Amministrativo","albo-pretorio-on-line");?>: <span style="font-weight:normal"><?php echo esc_html($Responsabile); ?></span></h4></li>   
                         </ul>                
                    </td>
                </tr>
            ...
            <tbody>
                        ...
                        <table style=" width:100%; border: none; margin-top: 10px; text-align: left; font-size: 130%; padding: 0">                            
                            <tr>
                                <td colspan="2" style="text-align:center;background: #fff; border: none;">
                                    <h3 style="font-weight: normal; font-size:130%; "><?php  esc_html_e("Sezione","albo-pretorio-on-line");?>: <?php echo esc_html(stripslashes($risultatocategoria->Nome)); ?></h3>
                                </td>
                            </tr>
                            <?php if ($tipo == 'c'): ?>
                                <tr>
                                    <td colspan="2" style="text-align:center;background: #fff; border: none; margin-bottom: 30px;">
                                        <?php  esc_html_e("Estremi del documento pubblicato","albo-pretorio-on-line");?>:
                                    </td>
                                </tr>
                            <?php endif; ?>
                            <tr>
                                <td style="font-weight: bold; text-align: right; width: 35%; padding: 5px; background: #efefef; border: none"><?php  esc_html_e("Ente titolare dell'Atto","albo-pretorio-on-line");?></td>
                            ...
                            <tr>
                                <td style="font-weight: bold; text-align: right; padding: 5px; background: #f6f6f6; border: none"><?php  esc_html_e("Numero Albo","albo-pretorio-on-line");?></td>
                            ...
                            <tr>
                                <td style="font-weight: bold; text-align: right; padding: 5px; background: #efefef; border: none"><?php  esc_html_e("Codice di Riferimento","albo-pretorio-on-line");?></td>
                            ...
                            <tr>
                                <td style="font-weight: bold; text-align: right; padding: 5px; background: #efefef; border: none"><?php  esc_html_e("Data atto","albo-pretorio-on-line");?></td>
                            ...
                            <tr>
                                <td style="font-weight: bold; text-align: right; padding: 5px; background: #f6f6f6; border: none"><?php  esc_html_e("Oggetto","albo-pretorio-on-line");?></td>
                            ...
                            <?php if ($risultato->Informazioni): ?>
                                <tr>
                                    <td style="font-weight: bold; text-align: right; padding: 5px; background: #efefef; border: none"><?php  esc_html_e("Soggetti","albo-pretorio-on-line");?>Note</td>
                ...
                <tr>
                    ...
                    <td style="font-size:130%; background: #fff; border: none; width:60%; padding-top:50px; padding-right:20px; text-align:right">
                        <strong><?php  esc_html_e("Il responsabile della pubblicazione","albo-pretorio-on-line");?></strong><br /><br />
                        <em><?php 
                        if($ResponsabilePub==''){ 
