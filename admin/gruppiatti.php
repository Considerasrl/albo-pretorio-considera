...
function Lista_AttiGruppo($Parametri){
	...
	echo '	<div class="tabalbo" style="margin-bottom:10px;">
		...
		<table id="elenco-atti-OldStyle" class="tabella-dati-albo" summary="'. esc_attr__("atti validi per riferimento, oggetto e categoria","albo-pretorio-considera").'">
...
echo '</div>';
	if ($CeAnnullato)
		echo '<p>'. sprintf(/* translators: %s: quadratino colorato di esempio */ esc_html__('Le righe evidenziate con questo sfondo %s indicano Atti Annullati','albo-pretorio-considera'),' <span style="background-color: '.esc_attr($coloreAnnullati).';">&nbsp;&nbsp;&nbsp;</span>').'</p>';
