...
<head>
	<title><?php _e("Albo OnLine","albo-pretorio-considera");?></title>
	<base target="_self" />
...
?>
	<div class="mceActionPanel">
		<form name="form" action="#" method="get" accept-charset="utf-8">
				<p>
				<label for="StatoAtti"><strong><?php _e("Stato Atti","albo-pretorio-considera");?></strong></label>
					<select id="StatoAtti" name="StatoAtti">
						<option value="1"><?php _e("Atti Correnti","albo-pretorio-considera");?></option>
						<option value="2"><?php _e("Atti Scaduti, Storico","albo-pretorio-considera");?></option>
					</select>
				</p>
				<p>
					<label for="Categoria"><strong><?php _e("Categoria","albo-pretorio-considera");?></strong></label>
					<?php echo $Ele_Cate; ?>
				</p>
				<p>
					<label for="Filtri"><strong><?php _e("Visualizza Filtri","albo-pretorio-considera");?></strong></label>
					<input type="checkbox" name="Filtri" id="Filtri" value="si"/>
				</p>
				<p>
					<label for="MinFiltri"><strong><?php _e("Finestra Filtri sempre visibile","albo-pretorio-considera");?></strong></label>
					<input type="checkbox" name="MinFiltri" id="MinFiltri" value="si"/>
				</p>
				<p>
					<label for="MinFiltri"><strong><?php _e("Numero atti da visualizzare","albo-pretorio-considera");?></strong></label>
