...
<head>
	<title><?php esc_html_e("Albo OnLine","albo-pretorio-considera");?></title>
	<base target="_self" />
...
?>
	<div class="mceActionPanel">
		<form name="form" action="#" method="get" accept-charset="utf-8">
				...
				<p>
					<label for="MinFiltri"><strong><?php esc_html_e("Numero atti da visualizzare","albo-pretorio-considera");?></strong></label>
